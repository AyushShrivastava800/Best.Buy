...
const initialListItems = listFromLocalStorage
  ? listFromLocalStorage.ProductWishlist
  : [];
...
export const { removeWishItem, clearWishList, addWishlist } = wishSlice.actions;
